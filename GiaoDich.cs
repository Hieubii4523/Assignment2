...
namespace Assignment2
{
    ...
    public class GiaoDich
    {
        ...
        public void InThongTin()
        {
            ...
            Console.WriteLine($"Mã GD: {MaGiaoDich}, Tài Khoản Gửi: {TaiKhoanGui.SoTaiKhoan}, Tài Khoản Nhận: {TaiKhoanNhan.SoTaiKhoan}, Loại: {(LoaiGiaoDich == LoaiGiaoDich.Gui ? "Gửi" : "Nhận")}");
            Console.ResetColor();
        }
    }
}
